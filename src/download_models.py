...
MDX_DOWNLOAD_LINK = 'https://huggingface.co/lj1995/VoiceConversionWebUI/tree/main/uvr5_weights/'
...
if __name__ == '__main__':
    mdx_model_names = ['HP5_only_main_vocal.pth', 'VR-DeEchoDeReverb.pth']
    for model in mdx_model_names:
        print(f'Downloading {model}...')
        dl_model(MDX_DOWNLOAD_LINK, model, mdxnet_models_dir)
